...
public class Jenkins {
	...
	public Jenkins(String citizenId, String citizenName, String citizenVaccinationCenter,
			String citizenVaccinationCenterId) {
		super();
	...
	public String toString() {
		return "Jenkins [citizenId=" + citizenId + ", citizenName=" + citizenName + ", citizenVaccinationCenter="
				+ citizenVaccinationCenter + ", citizenVaccinationCenterId=" + citizenVaccinationCenterId + "]";
	}
